...
folder are mapped to the application's root namespace, 'Fantasy'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Fantasy' in the same way
as `"Fantasy/sass/src"`.
